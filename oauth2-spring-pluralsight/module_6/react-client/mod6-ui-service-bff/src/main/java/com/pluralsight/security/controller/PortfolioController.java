...
public class PortfolioController {
    ...
    public PortfolioPositionsResponse portfolioPositions(@AuthenticationPrincipal JwtAuthenticationToken principal) {
        ...
        return this.webClient.get()
            ...
            .block(); // block() will force WebClient to be synchronous (to wait for response so behave like RestTemplate)
    }
